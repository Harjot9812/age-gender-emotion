...
def main():
    ...
    b0=Button(window,padx=16,pady=4,bd=4,fg="white",font=('arial',16,'bold'),width=21,height=2,bg="gray25",text='Image Recognition',command=ui)
    b0.place(x=70,y=150)
    b1=Button(window,padx=16,pady=4,bd=4,fg="white",font=('arial',16,'bold'),width=21,height=2,bg="gray25",text='Face Recognition',command=ui)
    b1.place(x=70,y=327)
